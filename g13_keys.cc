 ...
 */
// clang-format off
const std::vector<std::string> G13_KEY_STRINGS = {  // formerly G13_KEY_SEQ
    /* byte 3 */
...
const std::vector<std::string> G13_NONPARSED_KEYS = {"UNDEF1", "LIGHT_STATE", "UNDEF3",     "LIGHT",
...
const std::vector<std::string> G13_SYMBOLS = {
    ...
    "P","LEFTBRACE","RIGHTBRACE","ENTER","LEFTCTRL","RIGHTCTRL","A","S","D","F","G","H","J","K","L","SEMICOLON",
